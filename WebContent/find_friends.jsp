...
function Check()
{
	...
	<div id="sub2">
		<hr>
		<p align="center">
			<font size="6" color="blue"> 欢迎来到任我行 来查找你的同伴吧 </font>
		</p>
		<hr>
		<p align="center">查找旅友</p>

		<form name="form1" method="post" action="QueryUsers.jsp"
			onSubmit="return Check()" class="query_form">
			<table width="280" cellpadding="1" cellspacing="1" border="1"
				align="center">
				<tr>
					<td width="100" height="12" align="center">用户名</td>
					<td>
						<div align="center">
							<input name="username" type="text" id="username" size="20"><span>
								*您想找寻的用户名</span>
						</div>
					</td>
				</tr>
			...
			<p align="center">
				<input name="chaxun" type="submit" id="chaxun" value="查找旅友">
			</p>
		</form>
	</div>
<div class="zpy_yqlj">
