	...
	<div class="header">
		...
		<nav class="head_nav">
			<ul>
				...
				<li class="selected"><a href="sign_in.jsp">登陆账号</a></li>
...
<script type="text/javascript">
    function find_key(){
    	confirm("此功能即将上线，敬请期待");
    }
    function adminin(){
    	var f=document.form1;
    	if(f.username.value=="admin" && f.password.value=="0110"){
    		alert("登陆成功，跳转到后台管理系统")
    ...
    function userin(){
		...
		<form method="post" class="signin_form" name="form1" id="form1" onsubmit="userin();" action="validate_in.jsp">
			<table width="300px" border="3" align="center" cellpadding="0" cellspacing="1">
			<tr><td w idth="100" height="50"><div align="center">用户名:</div></td>
				<td width="150"><div align="center">
					<input name="username"  type="text" size="15"></div>
		        </td>
			</tr>
		    <tr>
			<td height="50"><div align="center">密 &nbsp;码:</div></td>
			<td><div align="center">
					<input name="password"  type="password" size="15"></div>
			</td>
		    </tr>
		</table>
			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="Sub1" type="submit" value="用户登陆" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="Sub2" type="button" value="管理员登陆" onclick="adminin();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    		<input name="Btn1" type="button" value="找回密码" onclick="find_key();">	
			</form>
			
<div class="signinyqlj">
